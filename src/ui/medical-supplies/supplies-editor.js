...
export default function SuppliesEditor() {
  ...
  useEffect(() => {
    ...
    fetch('https://hnjmr-server.onrender.com/api/medical-supplies?limit=999999999999999999&search='+search, 
  ...
  /* Fetch suppliers */
  useEffect(() => {
    fetch('https://hnjmr-server.onrender.com/api/lots/suppliers/all', { headers: {"accepts": "application/json"}})
      .then(res => res.json())
      .then(suppliers => {
  ...
  const handleSave = () => {
    ...
    fetch('https://hnjmr-server.onrender.com/api/medical-supplies/'+(option===1 ? selectedSupply.id_medical_supplies : ''), requestOptions)
      ...
      .then(data => {
        ...
        fetch('https://hnjmr-server.onrender.com/api/lots/'+(id ?? ''), requestOptions)
          .then(response => response.json())
          .then(lot => {
