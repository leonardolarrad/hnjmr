...
export default function HomePage() {
  ...
  const user = getUser();
  const posts = [
    'CgzSuCysoRe', 'CORPTK0nV_5', 'CXnzsUfudrl', 'CX8tXaaOfQE', 'CdQoRTnOwRL',
    'Cf3y2VvgiQ3', 'CjJnLRzu011', 'Cf-Yb4lswPc', 'CdjPpeGu-1c', 'CdS-sTVOOn5',
    'Ccn2CL2u69i', 'CcG9_AHM8T_', 'Cbz-lvEuoG5', 'CbYT0ZDu3sJ', 'Ca7xYonO5pc',
    'CZ1zoTQusTj', 'CY90oVJO7jK', 'CUv0TCGsE6U', 'CUdfTw1MtF9', 'CUddau6MtKD',
    'CSfuvR_MmMb', 'COeGpzPMoON', 'CMsVLR8MTbA', 'CK4t8XFMQUR', 'CJ38Sqxs2In',
    'CJRFW03sHeo', 'CJPFRwbsMXY', 'CHiYnHdMyv1', 'CHXqGI_Mduo', 'CGV30y3MtX7',
    'CDjhTLcscIM', 'CEAQte_ss2r', 'CC06bSjsyfj', 'CCmNn6UMbbo', 'CBtNotWMgJL',
    'CRFG5xuBUef', 'CRE_rOWBXKa', 'CREvJ1KBRmO', 'CQ9PZYdHzdh', 'CQ8Dr_bLkbS',
    'CQKJRHehIMT', 'CQKGxmeB6ay', 'CP9Sacqh068', 'CPvQulah_Xs', 'CPq0eZDnDR_',
    'CPCgWAggLKv', 'COoXjQfBwNi', 'COgl_f1JX2i', 'COT0-_7nrpQ', 'CN8rcTTHWUn',
    'CNqr5j8B3nr', 'CNqky-jH_47', 'CNYzx1dB4gx', 'CM03n75h-yw', 'CMsyXHynPsK',
    'CMXy9e0Dbka', 'CMGLdwonhN1', 'CL2G6GWli1H', 'CLVl2B8nbog', 'CLU9dD5Fcqy',
    'CJH7cz6ssKI', 'CJGvwjSByuM', 'CHJO8P_h4KP', 'CGDUz2HhtNI', 'CFpzzZthIbC',
  ]
