...
export default function Swtich({optionA, optionB, onSwitch }) {
  ...
  return (
    <div className="flex flex-row rounded-lg w-full h-fit  bg-light-4 dark:bg-dark-4 p-1">
      <button 
        className={" flex flex-row items-center justify-center w-full h-full rounded-l-lg p-2 "  +
      ...
      <button 
        className={" flex flex-row items-center justify-center w-full h-full rounded-r-lg p-2 " +
