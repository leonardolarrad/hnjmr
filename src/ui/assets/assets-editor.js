...
export default function AssetsEditor({mode}) {
  ...
  useEffect(() => {
    ...
    fetch('https://hnjmr-server.onrender.com/api/assets/'+id, { headers: {"accepts": "application/json"}})
      .then(res => res.json())
      .then(asset => {
  ...
  const handleSave = () => {
    ...
    fetch('https://hnjmr-server.onrender.com/api/assets/' + (id ? id : ''), requestOptions)
